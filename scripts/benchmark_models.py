...
def benchmark_models(cfg: DictConfig):
    ...
    logger.info(f"Starting Baseline Models Benchmark. Config:\n{OmegaConf.to_yaml(cfg)}")
    ...
    data_module = IntrusionDataModule(train_df_processed, val_df_processed, label_col, batch_size=cfg.training.batch_size)
    data_module.setup()
